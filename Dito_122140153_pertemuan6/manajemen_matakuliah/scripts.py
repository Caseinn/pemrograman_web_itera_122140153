...
def main():
    ...
    init_script = os.path.join(BASE_DIR, 'manajemen_matakuliah', 'scripts', 'initialize_db.py')
    sections.append(extract_file_summary(init_script, 'initialize_db.py'))

    # models
    model_dir = os.path.join(BASE_DIR, 'manajemen_matakuliah', 'models')
    ...
    # views
    views_dir = os.path.join(BASE_DIR, 'manajemen_matakuliah', 'views')
    ...
    # __init__.py root
    sections.append(extract_file_summary(os.path.join(BASE_DIR, 'manajemen_matakuliah', '__init__.py'), 'manajemen_matakuliah/__init__.py'))

    # routes.py
    routes_py = os.path.join(BASE_DIR, 'manajemen_matakuliah', 'routes.py')
